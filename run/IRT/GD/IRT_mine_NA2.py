...
parser.add_argument('--subjects', type=str, default='독해', help='Comma-separated list of subjects to include')
...
try:
    for i in range(args.trial):
        ...
        if args.evaluation == True:
            cdm.save(f"./results_NA2/{args.subjects}/irt.params")
            cdm.load(f"./results_NA2/{args.subjects}/irt.params")
